...
| FEAT-009 | Embedding Service — BioGPT/SciBERT batch GPU processing | P1 | open | 2 | embedding |
| FEAT-010 | Indexing Service — Weaviate write + PG status update | P1 | open | 2 | indexing |
| FEAT-011 | Indexing Coordinator — chunk completion tracking | P1 | open | 2 | indexing |
| FEAT-012 | DLQ alerting via CloudWatch | P1 | open | 2 | ops |
...
| FEAT-025 | Search relevance evaluation set | P2 | open | 2 | quality |
